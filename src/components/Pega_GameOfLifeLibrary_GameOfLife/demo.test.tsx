...
const { BasePegaGameOfLifeLibraryGameOfLife } = composeStories(DemoStories);

test('renders PegaGameOfLifeLibraryGameOfLife', async () => {
  render(<BasePegaGameOfLifeLibraryGameOfLife />);
